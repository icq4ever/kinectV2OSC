namespace KinectV2OSC
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        private void InitNetwork()
        {
            ...
            var kinectID = readKinectID();
            var port = Properties.Resources.PortNumber;
            this.bodySender = new BodySender(ipAddress, port, kinectID);
        }
        ...
        private string readKinectID()
        {
            string kinectID;
            try
            {
                System.IO.TextReader file = new StreamReader(Properties.Resources.kinectIDFileName);
                kinectID = file.ReadLine();
                file.Close();
                file = null;
            } catch (Exception)
            {
                System.Diagnostics.Debug.WriteLine("cannot read Kinect ID");
                kinectID = Properties.Resources.DefaultKinectID;
            }
            return kinectID;
        }
        ...
        private string ReadIpAddressCsv()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine("cannot read IP ADDR!");
